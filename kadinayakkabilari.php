...
$toplamKayitSayisiSorgusu = $dbConnection->prepare("select * from urunler where UrunTuru ='Kadın Ayakkabısı' and Durumu = '1'" . $menuKosulu . "" . $aramaKosulu . " order by id desc");
$toplamKayitSayisiSorgusu->execute();
$toplamKayitSayisi = $toplamKayitSayisiSorgusu->rowCount();
$sayfalamayaBaslanacakKayitSayisi = ($sayfalama * $sayfaBasinaGosterilecekKayitSayisi) - $sayfaBasinaGosterilecekKayitSayisi;
$bulunanSayfaSayisi = ceil($toplamKayitSayisi / $sayfaBasinaGosterilecekKayitSayisi);
$anaMenununTümUrunSayiSorgusu = $dbConnection->prepare("select sum(UrunSayisi) as MenununToplamUrunu from menuler where UrunTuru='Kadın Ayakkabısı'");
                ...
                <tr>
                    <td>
                        <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="30">
                                <td><a href="index.php?SK=85" style="text-decoration: none; font-weight: bold; 
                                <?php if ($gelenMenuId == '') {
                                    echo 'color: #FF9900;';
                                } else {
                                    echo 'color: #646464;';
                            ...
                            foreach ($MenuKayitlari as $Menu) {
                                ?>
                                <tr height="30">
                                    <td><a href="index.php?SK=85&MenuID=<?php echo $Menu["id"]; ?>" style="text-decoration: none; <?php if ($gelenMenuId == $Menu["id"]) { ?>color: #FF9900;<? } else { ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;<?php echo DonusumleriGeriDondur($Menu["MenuAdi"]); ?> (<?php echo DonusumleriGeriDondur($Menu["UrunSayisi"]); ?>)</a></td>
                                </tr>
                            <?php
                            }
                            ?>
                ...
                <tr>
                    <td>
                        <div class="AramaAlani">
                            <form action="<?php if ($menuKosulu != "") { ?>index.php?SK=85&MenuID=<?php echo $gelenMenuId;
                                                                                                    } else { ?>index.php?SK=85<?php } ?>" method="post">
                    ...
                    <td>
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <?php
                                $urunlerSorgusu = $dbConnection->prepare("select * from urunler where UrunTuru ='Kadın Ayakkabısı' and Durumu = '1'" . $menuKosulu . "" . $aramaKosulu . " order by id desc limit $sayfalamayaBaslanacakKayitSayisi, $sayfaBasinaGosterilecekKayitSayisi");
                                            ...
                                            <tr>
                                                <td align="center" width="191">
                                                    <a href="index.php?SK=83&ID=<?php echo donusumleriGeriDondur($kayit['id']); ?>">
                                                        <img width="185" height="247" src="Resimler/UrunResimleri/Kadin/<?php echo $kayit['UrunResmiBir']; ?>">
                                                    </a>
                                            </tr>
                                            <tr>
                                                <td align="center" width="191">
                            ...
                            <div class="SayfalamaAlaniKapsayicisi">
                                ...
                                <div class="SayfalamaAlanıIcinNumaraAlaniKapsayicisi">
                                    ...
                                    if ($sayfalama > 1) {
                                        ...
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=85" . $sayfalamaKosulu .  "&SYF=" . $safalamaIcinSayfaDegeriniBirGeriAL . "'> < </a></span>";
                                    }
                                    ...
                                    for (
                                        ...
                                        if (($sayfalamaIcinSayfaIndexDegeri > 0) and ($sayfalamaIcinSayfaIndexDegeri <= $bulunanSayfaSayisi)
                                            ...
                                            if ($sayfalama == $sayfalamaIcinSayfaIndexDegeri) {
                                                ...
                                                echo "<span class='SayfalamaPasif'><a href='index.php?SK=85" . $sayfalamaKosulu . "&SYF=" . $sayfalamaIcinSayfaIndexDegeri . "'>
$sayfalamaIcinSayfaIndexDegeri</a></span>";
                                    ...
                                    if ($sayfalama != $bulunanSayfaSayisi) {
                                        ...
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=85" . $sayfalamaKosulu .  "&SYF=" .
